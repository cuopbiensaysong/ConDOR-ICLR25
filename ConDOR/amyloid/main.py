...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', type=str, default='/home/user9/Condor/data/Amyloid') 
    parser.add_argument('--data_min', type=float, default=0.424, help='minimum value of Amyloid')
    parser.add_argument('--data_max', type=float, default=4.785, help='maximum value of Amyloid')
    parser.add_argument('--age_min', type=float, default=55.0, help='minimum value of ADNI age')
    parser.add_argument('--age_max', type=float, default=93.4, help='maximum value of ADNI age')
    parser.add_argument('--test_num', type=int, default=138, help='number of test data')
